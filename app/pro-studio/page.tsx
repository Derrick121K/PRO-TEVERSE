              ...
              {zipProject && (
                <div className="mt-5 rounded-2xl border border-emerald-400/20 bg-emerald-400/10 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-300">
                    {zipProject.projectName} - {summarizeZipProject(zipProject).activeTracks} active tracks - BPM {zipProject.bpm} - {zipProject.key}
                  </p>
                  <textarea
                    value={aiPrompt}
                  ...
                  {aiResult && (
                    <div className="mt-3 rounded-2xl border border-white/10 bg-black/30 p-4">
                      ...
                      <p className="mt-1 text-sm text-slate-300">
                        Source: {aiResult.source || "unknown"} - Notes: {aiResult.notes?.length || 0} - Pattern groups: {aiResult.pattern?.length || 0}
                      </p>
